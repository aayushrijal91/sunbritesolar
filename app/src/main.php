        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="government_benefits_inner">
                    <?= renderImg('cartoon_hand_elec.png', 'lib', 'cartoon_hand_elec') ?>
                    <div class="row justify-content-center position-relative">
                        <div class="col-lg-8">
                            <div class="fs-64 lh-1 pb-6">Seize Government Benefits and Solar Rewards Today</div>
                            <a href="tel:<?= $phone_number ?>" class="btn border-dark d-inline-flex rounded-0 text-dark py-3 px-md-5">
                                Enquire Now
                            </a>
                        </div>
                    </div>
                    <?= renderImg('cartoon_solar_panel.png', 'lib', 'cartoon_solar_panel') ?>
        ...
        <div class="position-relative">
            <div class="row top_row">
                <div class="col-lg-4">
                    ...
                    <div class="fs-36 pt-5 pb-6">Sydney's Go-To Solar</div>
                    <?= renderImg('clean-energy-council.png', 'logo') ?>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-auto">
                            <div class="fs-26 fw-700 py-5">Quick Links</div>
                        ...
                        <div class="col">
                            <div class="fs-26 fw-700 py-5">Contact</div>
                            <ul class="footer_menu">
                    ...
                    <div class="row align-items-center gx-5 pt-5">
                        <div class="col-auto">
                            <a href="" class="">
            ...
            <div class="fs-20 pt-4 pb-5">
                Copyright © 2023 Sunbrite Solar | Terms and Conditions | Privacy Policy Website by AiiMS Group Pty Ltd <a href="https://www.aiims.com.au/like-our-work/" target="_blank" class="ps-4"><?= renderImg('aiims1.png', 'logo') ?></a>
            </div>
        </div>
